...
export function mergeCard(base: Card, ours: Card, theirs: Card): EntityMergeResult<Card> {
  ...
  const value: Card = {
    ...
    recurrence: threeWayScalar(base.recurrence, ours.recurrence, theirs.recurrence, sameJson).value,
    recurrenceNextId: threeWayScalar(base.recurrenceNextId, ours.recurrenceNextId, theirs.recurrenceNextId).value,
    recurrenceSourceId: threeWayScalar(base.recurrenceSourceId, ours.recurrenceSourceId, theirs.recurrenceSourceId).value,
...
export function mergeSettings(base: WorkspaceSettings, ours: WorkspaceSettings, theirs: WorkspaceSettings): EntityMergeResult<WorkspaceSettings> {
  const value: WorkspaceSettings = {
    ...
    slackMovedToListNames: threeWayScalar(base.slackMovedToListNames, ours.slackMovedToListNames, theirs.slackMovedToListNames).value,
    slackNotifications: {
